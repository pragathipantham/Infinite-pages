  ...
  ngOnInit() {
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      customer: this.formBuilder.group({
        firstName: [
          sessionStorage.getItem('firstName'),[Validators.required,Validators.pattern('[A-Za-z]+')]],
        lastName: [
          sessionStorage.getItem('lastName'),[Validators.required,Validators.pattern('[A-Za-z]+')]],
        email: [
          sessionStorage.getItem('email'),[Validators.required,Validators.email]],
        mobile: [
          sessionStorage.getItem('mobile'),[Validators.required,Validators.pattern('[6-9][0-9]{9}')]],
      }),
